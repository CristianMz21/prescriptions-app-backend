...
describe('AuthController', () => {
  ...
  describe('getProfile', () => {
    it('should return the user profile from the database', async () => {
      const requestUser = { id: 'user-1', email: 'test@clinic.com', role: Role.PATIENT };
      const fullUserEntity = { ...requestUser, createdAt: new Date(), updatedAt: new Date(), passwordHash: 'hash' };
      
      usersService.findById.mockResolvedValue(fullUserEntity as any);
